  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white text-slate-800">
      ...
      <section className="text-center py-24 px-4 sm:px-6 lg:px-8">
        ...
        >
          The perfect blend of calendar and note-taking. Keep track of your
          schedule while taking detailed notes for every event.
        </motion.p>
        <motion.div
          variants={fadeUp}
          initial="hidden"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <div className="w-full max-w-2xl rounded-lg overflow-hidden shadow-lg">
              ...
              >
                <source
                  src="/Screen Recording 2025-04-16 203907.mp4"
                  type="video/mp4"
                />
              </video>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-slate-400">
              Organize your life with smart calendar and note-taking features.
            </p>
          </div>
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#" className="hover:text-indigo-300 text-slate-400">
                  Home
                </a>
              </li>
              <li>
                <a
                  href="#features"
                  className="hover:text-indigo-300 text-slate-400"
                >
                  Features
                </a>
              </li>
